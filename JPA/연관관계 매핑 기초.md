...
> 결론: 외래키를 직접 관리하는 테이블에 맞춘 객체 모델링은 객체간의 협력관계를 만들 수 없고, 객체가 참조를 통해 연관객체를 찾는 다는 사상을 적용할 수 없다. 
...
![picture6](https://github.com/JaeYeon33/TIL/blob/main/JPA/image/Untitled%205.png?raw=true)
